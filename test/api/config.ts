...
// Next file is auto generated by tetu-contracts-io/scripts/multiswap/fetchFeeOnTransferTokens.ts
import tokensFeeJson from './data/FeeOnTransferTokens.json';
...
export const UNISWAP_SUBGRAPHS = {
    [Network.POLYGON]: [
        ...
        },
        {
            name: 'QuickSwap',
            dexId: dexId++,
            // url: 'https://api.thegraph.com/subgraphs/name/sameepsi/quickswap06', // was indexing error
...
// Tokens with error / fee on transfer.
/*export const EXCLUDE_TOKENS = {
    [Network.POLYGON]: [
        ...
        '0xc8bcb58caEf1bE972C0B638B1dD8B0748Fdc8A44'.toLowerCase(), // PEAR
        // Transfer disabled
        '0x17e9c5b37283ac5fbe527011cec257b832f03eb3'.toLowerCase(), // trade off, old SPHERE token
    ],
};*/

// ------------ excluded (fee or error on transfer) tokens load
export interface IFeeTokenData {
    address: string;
    decimals: number;
    symbol: string;
    fee: string;
...
export interface IFeeTokens {
    [address: string]: IFeeTokenData;
}

export const apiExcludeTokensMatic = Object.values(tokensFeeJson as IFeeTokens)
    .filter((t) => t.fee !== '0')
    .map((t) => t.address);

export const EXCLUDE_TOKENS = {
    [Network.POLYGON]: apiExcludeTokensMatic,
};
